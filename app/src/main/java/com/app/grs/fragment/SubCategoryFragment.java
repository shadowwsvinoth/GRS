...
public class SubCategoryFragment extends Fragment {
    ...
    String catname = Constants.categoryname;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new fetchSubCategory(getActivity(), catid).execute();
    ...
    private class fetchSubCategory extends AsyncTask<String, Void, String> {
        ...
        public fetchSubCategory(Context context, String catid) {
            this.context = context;
            this.catid = catid;
        }
            ...
            try {
                ...
                if (jonj.getString("status").equalsIgnoreCase(
                    ...
                    for(int i=0;i<array.length();i++) {
                        ...
                        subcatid=jcat.getString("subcategory_id");
                        subcatimgpath=jcat.getString("image_url");
                        subcatimgname=jcat.getString("image_name");
                        subcatname=jcat.getString("subcategory_name");

                        map.put("subcategory_id",subcatid);
                        map.put("image_url",subcatimgpath);
                        map.put("image_name",subcatimgname);
                        map.put("subcategory_name",subcatname);
